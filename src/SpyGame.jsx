...
const WORD_BANK = [
    { word: "מסעדה", easyHint: "זרים", hardHint: "עמוד" },
    { word: "בית חולים", easyHint: "פעמון", hardHint: "מסדרון" },
    { word: "שדה תעופה", easyHint: "גלגלים", hardHint: "זכוכית" },
    { word: "בית ספר", easyHint: "גיר", hardHint: "ריבוע" },
    { word: "בסיס צבאי", easyHint: "שער", hardHint: "חול" },
    { word: "סופרמרקט", easyHint: "גלגלים", hardHint: "סרט" },
    { word: "קולנוע", easyHint: "חושך", hardHint: "כיסא" },
    { word: "איצטדיון", easyHint: "דשא", hardHint: "מעגל" },
    { word: "מוזיאון", easyHint: "חבל", hardHint: "זכוכית" },
    { word: "חוף הים", easyHint: "גרגירים", hardHint: "רוח" },
    { word: "פארק שעשועים", easyHint: "ברזל", hardHint: "סיבוב" },
    { word: "תחנת משטרה", easyHint: "ספסל", hardHint: "נייר" },
    { word: "תחנת כיבוי אש", easyHint: "מוט", hardHint: "אדום" },
    { word: "מלון", easyHint: "מספר", hardHint: "כרית" },
    { word: "בנק", easyHint: "מסך", hardHint: "תור" },
    { word: "משרד", easyHint: "מסך", hardHint: "כיסא" },
    { word: "ספרייה", easyHint: "שתיקה", hardHint: "מדף" },
    { word: "בית כנסת", easyHint: "כיוון", hardHint: "ספר" },
    { word: "גן חיות", easyHint: "שלט", hardHint: "ריח" },
    { word: "חדר כושר", easyHint: "השתקפות", hardHint: "ברזל" },
    { word: "ספא", easyHint: "אדים", hardHint: "אבנים" },
    { word: "תחנת רכבת", easyHint: "פסים", hardHint: "ספסל" },
    { word: "נמל", easyHint: "חלודה", hardHint: "חבל" },
    { word: "תחנת דלק", easyHint: "ספרות", hardHint: "ריח" },
    { word: "בית קפה", easyHint: "פינה", hardHint: "קצף" },
    { word: "קניון", easyHint: "הד", hardHint: "זכוכית" },
    { word: "מוסך", easyHint: "שמן", hardHint: "בור" },
    { word: "מספרה", easyHint: "כיסא", hardHint: "רצפה" },
    { word: "תיאטרון", easyHint: "חושך", hardHint: "אדום" },
    { word: "קרקס", easyHint: "עיגול", hardHint: "פחד" },
    { word: "כלא", easyHint: "ספירה", hardHint: "ברזל" },
    { word: "בית משפט", easyHint: "עץ", hardHint: "ספסל" },
    { word: "שגרירות", easyHint: "דגל", hardHint: "חותמת" },
    { word: "אוניברסיטה", easyHint: "קמפוס", hardHint: "ספסל" },
    { word: "גן ילדים", easyHint: "צבע", hardHint: "גדר" },
    { word: "סדנת אמנות", easyHint: "ידיים", hardHint: "כתם" },
    { word: "מעבדה", easyHint: "טיפה", hardHint: "שקוף" },
    { word: "בית אבות", easyHint: "מסדרון", hardHint: "איטי" },
    { word: "מגדלור", easyHint: "סיבוב", hardHint: "בודד" },
    { word: "טירה", easyHint: "אבן", hardHint: "קור" },
    { word: "תחנת חלל", easyHint: "ציפה", hardHint: "שקט" },
    { word: "צוללת", easyHint: "פלדה", hardHint: "לחץ" },
    { word: "מטוס", easyHint: "ענן", hardHint: "חגורה" },
    { word: "ספינת פיראטים", easyHint: "עץ", hardHint: "דגל" },
    { word: "מכרה זהב", easyHint: "חושך", hardHint: "קסדה" },
    { word: "מדבר", easyHint: "צל", hardHint: "חול" },
    { word: "יער", easyHint: "צל", hardHint: "ירוק" },
    { word: "מערה", easyHint: "הד", hardHint: "חושך" },
    { word: "הר מושלג", easyHint: "לבן", hardHint: "נשימה" },
    { word: "אי בודד", easyHint: "מעגל", hardHint: "שקט" },
    { word: "ג'ונגל", easyHint: "ירוק", hardHint: "רטיבות" },
    { word: "מקדש", easyHint: "אבן", hardHint: "הד" },
    { word: "חממה", easyHint: "זיעה", hardHint: "ירוק" },
    { word: "מגדל פיקוח", easyHint: "זכוכית", hardHint: "גובה" },
    { word: "אולם אירועים", easyHint: "הד", hardHint: "רצפה" },
    { word: "בריכת שחייה", easyHint: "ריח", hardHint: "כחול" },
    { word: "מרפאת שיניים", easyHint: "כיסא", hardHint: "אור" },
    { word: "וטרינר", easyHint: "פרווה", hardHint: "דאגה" },
    { word: "פיצרייה", easyHint: "חום", hardHint: "מספר" },
    { word: "מאפייה", easyHint: "חלון", hardHint: "בוקר" },
    { word: "גלריית אמנות", easyHint: "צעדים", hardHint: "לבן" },
    { word: "חנות בגדים", easyHint: "מראה", hardHint: "תווית" },
    { word: "חנות צעצועים", easyHint: "צבעים", hardHint: "קופסה" },
    { word: "חנות ספרים", easyHint: "מדף", hardHint: "שתיקה" },
    { word: "בית מרקחת", easyHint: "לבן", hardHint: "תור" },
    { word: "שוק", easyHint: "קולות", hardHint: "ערבוב" },
    { word: "מטווח", easyHint: "פגיעה", hardHint: "ריכוז" },
    { word: "מגרש גולף", easyHint: "דגל", hardHint: "ירוק" },
    { word: "אתר סקי", easyHint: "לבן", hardHint: "מהירות" },
    { word: "יקב", easyHint: "חביות", hardHint: "זמן" },
    { word: "אקווריום", easyHint: "זכוכית", hardHint: "כחול" },
    ...
    { word: "בית דפוס", easyHint: "שחור", hardHint: "חזרה" },
    { word: "אולפן הקלטות", easyHint: "ספוג", hardHint: "בידוד" },
    { word: "אולפן טלוויזיה", easyHint: "אור", hardHint: "שעון" },
    ...
    { word: "כוורת", easyHint: "מתוק", hardHint: "סדר" },
    ...
    { word: "מגרש טניס", easyHint: "רשת", hardHint: "גבולות" },
    { word: "פארק מים", easyHint: "צעקות", hardHint: "בטן" },
    { word: "משתלה", easyHint: "אדמה", hardHint: "ירוק" },
    ...
    { word: "מעבורת", easyHint: "מים", hardHint: "חזרה" },
    { word: "תחנת מחקר בקוטב", easyHint: "לבן", hardHint: "בידוד" },
    ...
    { word: "חדר בריחה", easyHint: "מנעול", hardHint: "תסכול" },
